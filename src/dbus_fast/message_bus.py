...
class BaseMessageBus:
    ...
    def __init__(
        ...
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, class __init__, enter" )
    ...
    def export(self, path: str, interface: ServiceInterface) -> None:
        ...
        """
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, export, enter" )
    ...
    def unexport(
        ...
        :raises:
            - :class:`InvalidObjectPathError <dbus_fast.InvalidObjectPathError>` - If the given object path is not valid.
        """
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, unexport, enter" )
        assert_object_path_valid(path)
    ...
    def introspect(
        ...
        """
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, introspect, enter" )
    ...
    def _emit_interface_added(self, path: str, interface: ServiceInterface) -> None:
        ...
        :type interface: :class:`ServiceInterface
            <dbus_fast.service.ServiceInterface>`
        """
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, _emit_interface_added, enter" )
    ...
    def request_name(
        ...
        :raises:
            - :class:`InvalidBusNameError <dbus_fast.InvalidBusNameError>` - If the given bus name is not valid.
        """
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, request_name, enter" )
    ...
    def release_name(
        ...
        :raises:
            - :class:`InvalidBusNameError <dbus_fast.InvalidBusNameError>` - If the given bus name is not valid.
        """
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, release_name, enter" )
        assert_bus_name_valid(name)
    ...
    def get_proxy_object(
        ...
        """
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, get_proxy_object, enter" )
    ...
    def _callback_method_handler(
        ...
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, _callback_method_handler, enter" )
    ...
    def _default_get_machine_id_handler(
        ...
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, _default_get_machine_id_handler, enter" )
        if self._machine_id:
    ...
    def _init_high_level_client(self) -> None:
        ...
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, _init_high_level_client, enter" )
    ...
    def _add_match_rule(self, match_rule):
        ...
        high level client only."""
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, _add_match_rule, enter" )
    ...
    def _remove_match_rule(self, match_rule):
        ...
        print( "in \\dbus-fast\\src\\dbus_fast\\message_bus, _remove_match_rule, enter" )
        if match_rule == self._name_owner_match_rule:
            return
